	...
	function (msg, state) {
		...
		switch (msg.$) {
			case 'Increment':
				...
				return (incrementable && A3($author$project$Bubblesort$ordered, i, i + 1, numbers)) ? $elm$core$Result$Ok('Incremented i') : $elm$core$Result$Err('Cannot increment i');
			case 'SwapAndIncrement':
				var incrementable = _Utils_cmp(i, b - 1) < 0;
				return (incrementable && (!A3($author$project$Bubblesort$ordered, i, i + 1, numbers))) ? $elm$core$Result$Ok('Swapped i and i+1, Incremented i') : $elm$core$Result$Err('Cannot swap and increment i');
...
var $author$project$Bubblesort$next = function (state) {
	...
	var b = _v0.b;
	var numbers = _v0.numbers;
	return ((!i) && (b === 1)) ? _List_Nil : ((_Utils_cmp(i, b - 1) < 0) ? (A3($author$project$Bubblesort$ordered, i, i + 1, numbers) ? _List_fromArray(
		[$author$project$Bubblesort$Increment]) : _List_fromArray(
		[$author$project$Bubblesort$SwapAndIncrement])) : _List_fromArray(
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Bubblesort$Increment)
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Bubblesort$SwapAndIncrement)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Swap And Increment I')
							])),
						A2(
						$elm$html$Html$button,
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Bubblesort$DecrementBAndResetI)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Decrement I and Reset B')
							]))
					]))
			]));
};
